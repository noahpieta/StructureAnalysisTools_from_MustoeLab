...
# Contact Distance Fixed Again, now uses a breadth first search algorithm
...
class CT(object):
	...
	def readCT(self, fIN, structNum = 0, filterNC = False):
		...
		try:
			...
			sys.exit("file is not in .ct format. Requires Header")
	...
	def pair2CT(self, pairs, seq, name=None, skipConflicting=True, filterNC=False):
		"""
